			    ...
			    <div class="modal-content">
					 <?php
						...
						if(isset($_POST["simpan"])) {
							...
							$sql="INSERT INTO perlengkapan VALUES('','$a','$b','$c')";
							$hasil=mysqli_query($aqua,$sql);

							if($hasil) {
								echo"<script>window.alert('DATA BERHASIL DISIMPAN');;window.location='../admin/perlengkapan.php'</script>";
							} 
								else {
									echo $aqua->error;
								}			
							...
							<div class="row">
								...
								<div class="row">
									<div class="input-field">
			            				...
			            				<label for="fungsi">Fungsi Perlengkapan</label>
									</div>
								</div>
								<div class="row">
									<div class="input-field">
			...
			<table id="datafauna" class="display responsive-table" cellspacing="0" width="100%">
		        ...
		        <tbody>
					...
					while ($row = $query->fetch_array()){;?>
					    <tr>
					    	<td><?php echo $no++;?></td>
					        <td><?php echo $row['NamaPerlengkapan'];?></td>
					        <td><?php echo $row['FungsiPerlengkapan'];?></td>
					        <td><?php echo'<img width="100" src="../hardscape/'.$row['fotoperlengkapan'].'">  ';?></td>
					        <td>
					        	<?php echo'<a class="btn-floating waves-effect waves-light blue" href="epe.php?kode='.$row['idperlengkapan'].'"><i class="material-icons">mode_edit</i></a>';?>
					        	<?php echo'<a onclick="return hapus()" href="dpe.php?kode='.$row['idperlengkapan'].'" class="btn-floating waves-effect waves-light red"><i class="material-icons">delete</i></a>';?>
					        </td>
					    </tr>
					<?php };?>
				</tbody>
