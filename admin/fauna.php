						...
						if(isset($_POST["simpan"])) {
							...
							if (strlen($d)>0) {
								if (is_uploaded_file($_FILES["foto"]["tmp_name"])) {
									move_uploaded_file ($_FILES["foto"]["tmp_name"], "../fauna/".$d);
								}
							}

							$sql="INSERT INTO fauna VALUES('','$a','$b','$c','$d')";
							$hasil=mysqli_query($aqua,$sql);

							if($hasil) {
								echo"<script>window.alert('DATA BERHASIL DISIMPAN');;window.location='../admin/fauna.php'</script>";
							} 
								else {
									echo $aqua->error;
								}			
							...
							<div class="row">
								...
								<div class="row">
									...
									<div class="col s12 m6 l6 input-field">
										...
										<select class="" name="jenis" id="jenis">
									      <option value="nakal">Galak</option>
									      <option value="bersahabat">Jinak</option>
									    </select>
								...
								<div class="row">
									<div class="input-field">
			            				...
			            				<label for="keterangan">Keterangan Fauna</label>
									</div>
								</div>
								<div class="row">
									<div class="input-field">
		        ...
		        <tbody>
					...
					while ($row = $query->fetch_array()){;?>
					    <tr>
					        ...
					        <td>
					        	<?php echo'<a class="btn-floating waves-effect waves-light blue" href="efa.php?kode='.$row['idfauna'].'"><i class="material-icons">mode_edit</i></a>';?>
					        	<?php echo'<a onclick="return hapus()" href="dfa.php?kode='.$row['idfauna'].'" class="btn-floating waves-effect waves-light red"><i class="material-icons">delete</i></a>';?>
					        </td>
					    </tr>
					<?php };?>
				</tbody>
