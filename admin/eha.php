...
<?php
	...
	$id = $_GET['kode'];
	$SQL_DATA = $aqua->query("SELECT * FROM hardscape WHERE idhardscape='$id'");
				...
				<div class="container">
					 <?php
						...
						if(isset($_POST["edit"])) {
							...
							$sql="UPDATE hardscape SET NamaHardscape='$a',FungsiHardscape='$b' WHERE idhardscape='$id'";
							$hasil=mysqli_query($aqua,$sql);

							if($hasil) {
								echo"<script>window.alert('DATA BERHASIL DI EDIT');;window.location='../admin/hardscape.php'</script>";
							} 
								else {
									echo $aqua->error;
								}			
							...
							<div class="row">
								...
								<div class="row">
									<div class="col s12 m6 l6 input-field">
										...
										<input type="text" name="nama" value="'.$data['NamaHardscape'].'" id="icon_prefix">
								...
								<div class="row">
									<div class="input-field">
										...
										<input type="text" name="fungsi" value="'.$data['FungsiHardscape'].'" id="icon_prefix">
								...
								<div class="row">
									<div class="input-field center-align">
										...
										<a href="hardscape.php" class="waves-effect waves-light btn">Batal</a>
									</div>
								</div>
							</div>
					</form>
